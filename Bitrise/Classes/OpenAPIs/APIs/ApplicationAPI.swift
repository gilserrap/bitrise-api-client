...
open class ApplicationAPI {
     ...
     */
    open class func appConfigDatastoreShow(appSlug: String, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
        appConfigDatastoreShowWithRequestBuilder(appSlug: appSlug).execute(apiResponseQueue) { result -> Void in
            switch result {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func appList(sortBy: SortBy_appList? = nil, next: String? = nil, limit: Int? = nil, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0AppListResponseModel?,_ error: Error?) -> Void)) {
        appListWithRequestBuilder(sortBy: sortBy, next: next, limit: limit).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func appListWithRequestBuilder(sortBy: SortBy_appList? = nil, next: String? = nil, limit: Int? = nil) -> RequestBuilder<V0AppListResponseModel> {
        ...
        let requestBuilder: RequestBuilder<V0AppListResponseModel>.Type = BitriseAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func appListByOrganization(orgSlug: String, sortBy: SortBy_appListByOrganization? = nil, next: String? = nil, limit: Int? = nil, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0AppListResponseModel?,_ error: Error?) -> Void)) {
        appListByOrganizationWithRequestBuilder(orgSlug: orgSlug, sortBy: sortBy, next: next, limit: limit).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func appListByUser(userSlug: String, sortBy: SortBy_appListByUser? = nil, next: String? = nil, limit: Int? = nil, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0AppListResponseModel?,_ error: Error?) -> Void)) {
        appListByUserWithRequestBuilder(userSlug: userSlug, sortBy: sortBy, next: next, limit: limit).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func appShow(appSlug: String, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0AppShowResponseModel?,_ error: Error?) -> Void)) {
        appShowWithRequestBuilder(appSlug: appSlug).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func appShowWithRequestBuilder(appSlug: String) -> RequestBuilder<V0AppShowResponseModel> {
        ...
        let requestBuilder: RequestBuilder<V0AppShowResponseModel>.Type = BitriseAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func branchList(appSlug: String, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0BranchListResponseModel?,_ error: Error?) -> Void)) {
        branchListWithRequestBuilder(appSlug: appSlug).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func branchListWithRequestBuilder(appSlug: String) -> RequestBuilder<V0BranchListResponseModel> {
        ...
        let requestBuilder: RequestBuilder<V0BranchListResponseModel>.Type = BitriseAPI.requestBuilderFactory.getBuilder()
