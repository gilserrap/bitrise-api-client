...
open class BuildArtifactAPI {
     ...
     */
    open class func artifactDelete(appSlug: String, buildSlug: String, artifactSlug: String, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0ArtifactDeleteResponseModel?,_ error: Error?) -> Void)) {
        artifactDeleteWithRequestBuilder(appSlug: appSlug, buildSlug: buildSlug, artifactSlug: artifactSlug).execute(apiResponseQueue) { result -> Void in
            switch result {
    ...
    open class func artifactDeleteWithRequestBuilder(appSlug: String, buildSlug: String, artifactSlug: String) -> RequestBuilder<V0ArtifactDeleteResponseModel> {
        ...
        let requestBuilder: RequestBuilder<V0ArtifactDeleteResponseModel>.Type = BitriseAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func artifactList(appSlug: String, buildSlug: String, next: String? = nil, limit: Int? = nil, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0ArtifactListResponseModel?,_ error: Error?) -> Void)) {
        artifactListWithRequestBuilder(appSlug: appSlug, buildSlug: buildSlug, next: next, limit: limit).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func artifactListWithRequestBuilder(appSlug: String, buildSlug: String, next: String? = nil, limit: Int? = nil) -> RequestBuilder<V0ArtifactListResponseModel> {
        ...
        let requestBuilder: RequestBuilder<V0ArtifactListResponseModel>.Type = BitriseAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func artifactShow(appSlug: String, buildSlug: String, artifactSlug: String, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0ArtifactShowResponseModel?,_ error: Error?) -> Void)) {
        artifactShowWithRequestBuilder(appSlug: appSlug, buildSlug: buildSlug, artifactSlug: artifactSlug).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func artifactShowWithRequestBuilder(appSlug: String, buildSlug: String, artifactSlug: String) -> RequestBuilder<V0ArtifactShowResponseModel> {
        var path = "/apps/{app-slug}/builds/{build-slug}/artifacts/{artifact-slug}"
        let appSlugPreEscape = "\(APIHelper.mapValueToPathItem(appSlug))"
        let appSlugPostEscape = appSlugPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{app-slug}", with: appSlugPostEscape, options: .literal, range: nil)
        ...
        let requestBuilder: RequestBuilder<V0ArtifactShowResponseModel>.Type = BitriseAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func artifactUpdate(appSlug: String, buildSlug: String, artifactSlug: String, artifactParams: V0ArtifactUpdateParams, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0ArtifactShowResponseModel?,_ error: Error?) -> Void)) {
        artifactUpdateWithRequestBuilder(appSlug: appSlug, buildSlug: buildSlug, artifactSlug: artifactSlug, artifactParams: artifactParams).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func artifactUpdateWithRequestBuilder(appSlug: String, buildSlug: String, artifactSlug: String, artifactParams: V0ArtifactUpdateParams) -> RequestBuilder<V0ArtifactShowResponseModel> {
        ...
        path = path.replacingOccurrences(of: "{artifact-slug}", with: artifactSlugPostEscape, options: .literal, range: nil)
        let URLString = BitriseAPI.basePath + path
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: artifactParams)
