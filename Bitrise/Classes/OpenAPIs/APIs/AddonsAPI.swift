...
open class AddonsAPI {
     ...
     */
    open class func addonListByApp(appSlug: String, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0AppAddOnsListResponseModel?,_ error: Error?) -> Void)) {
        addonListByAppWithRequestBuilder(appSlug: appSlug).execute(apiResponseQueue) { result -> Void in
            switch result {
    ...
    open class func addonListByAppWithRequestBuilder(appSlug: String) -> RequestBuilder<V0AppAddOnsListResponseModel> {
        ...
        let requestBuilder: RequestBuilder<V0AppAddOnsListResponseModel>.Type = BitriseAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func addonListByOrganization(organizationSlug: String, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0OwnerAddOnsListResponseModel?,_ error: Error?) -> Void)) {
        addonListByOrganizationWithRequestBuilder(organizationSlug: organizationSlug).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func addonListByOrganizationWithRequestBuilder(organizationSlug: String) -> RequestBuilder<V0OwnerAddOnsListResponseModel> {
        ...
        let requestBuilder: RequestBuilder<V0OwnerAddOnsListResponseModel>.Type = BitriseAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func addonListByUser(userSlug: String, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0OwnerAddOnsListResponseModel?,_ error: Error?) -> Void)) {
        addonListByUserWithRequestBuilder(userSlug: userSlug).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func addonsList(apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0AddonsListResponseModel?,_ error: Error?) -> Void)) {
        addonsListWithRequestBuilder().execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func addonsListWithRequestBuilder() -> RequestBuilder<V0AddonsListResponseModel> {
        ...
        let requestBuilder: RequestBuilder<V0AddonsListResponseModel>.Type = BitriseAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func addonsShow(addonId: String, apiResponseQueue: DispatchQueue = BitriseAPI.apiResponseQueue, completion: @escaping ((_ data: V0AddonsShowResponseModel?,_ error: Error?) -> Void)) {
        addonsShowWithRequestBuilder(addonId: addonId).execute(apiResponseQueue) { result -> Void in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func addonsShowWithRequestBuilder(addonId: String) -> RequestBuilder<V0AddonsShowResponseModel> {
        ...
        let requestBuilder: RequestBuilder<V0AddonsShowResponseModel>.Type = BitriseAPI.requestBuilderFactory.getBuilder()
